...
<!--面包屑导航 开始-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                ...
                <a href="{{url('admin/category/create')}}"><i class="fa fa-sliders"></i>添加分类</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>开源网站：</label><span><a href="https://github.com/yiluohan1234/blog" target="_blank">https://github.com/yiluohan1234/blog</a></span>
                </li>
                <!--
                <li>
